...
to setup-patches
  ...
  ;DEFINIR ZONA DO DEPOSITO DO LIXO
  ...
  ask aspiradores [
    ...
    [ ; Avança normalmente
      ...
      [
        ...
        ifelse locDeposito != nobody [  ; Detetou o depósito na vizinhança
          move-to locDeposito
